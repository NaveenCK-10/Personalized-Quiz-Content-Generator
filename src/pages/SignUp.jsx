  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center p-4 text-white pt-24">
        <div className="text-center mb-8">
            <h1 className="text-4xl font-bold tracking-tight mt-4 text-shadow-lg">Create Your Account</h1>
            <p className="text-lg text-pink-200 mt-2">Join and start learning with AI today!</p>
        </div>
